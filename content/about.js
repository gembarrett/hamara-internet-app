    ...
    goals: [
      {
        ...
        titlePK: "ڈیجیٹل بد سلوکی سے حفاظت",
        textEN: "To protect women against cyber harassment and to promote better understanding of using safe and secure Internet.",
        textPK: "خواتین کو سائبر ہراسگی سے بچانا اور انٹرنیٹ کے محفوظ استعمال  کی بہتر عوامل کو آگے بڑھانا۔"
      },
      {
        icon: "puzzle-piece",
        titleEN: "Capacity Building",
        titlePK: "صلاحیتوں کو اجاگر کرنا",
        ...
        textPK: "خواتین کو اس قابل بنانا کہ وہ انٹرنیٹ پہ اپنا مقام حاصل کریں اور سوشل میڈیا پہ مزید مستعد ہوجائیں، تاکہ ان کی صلاحیتیں اجاگر ہونے کے ساتھ ساتھ آن لائن سپیس میں انہیں خود مختاری بھی حاصل ہو۔"
      },
      {
        icon: "female",
      ...
      },
      {
        ...
        titlePK: "ڈیجیٹل تعلیم کو فروغ دینا",
        ...
        textPK: "خواتین کو انٹرنیٹ پر اپنے خیالات کے اظہار کیلئے مناسب تجاویز اور ٹولز فراہم کرنا اور انہیں ڈیجیٹل طور پر باخبر بنانا تاکہ وہ نہ صرف خود ڈیجیٹل فضا کا مؤثر استعمال کریں بلکہ ان سے شناسا ہوکر اپنے عزیزو اقارب کی مدد بھی کریں۔"
      },
      {
        icon: "umbrella",
