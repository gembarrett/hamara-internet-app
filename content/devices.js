...
const virus = [
  ...
  },
  {
    ...
    textPK: "<ul><li> جیسے مشہور اینٹی وائرس سافٹ ویئر ہی انسٹال کریں <a href='https://www.avast.com' target='_blank'>Avast<\/a> اور<a href='https://www.norton.com' target='_blank'>Norton<\/a>, <a href='https://www.avira.com/' target='_blank'>Avira<\/a>۔ صرف <\/li><li>۔ اینٹی مالویئر سافٹ ویئر اور اینٹی سپائے ویئر کی تنصیب بھی کریں یعنی جتنے زیادہ حفاظتی اقدام آپ کریں گے اتنے     تجویز کرتے ہیں کیونکہ  <a href='https://www.safer-networking.org/' target='_blank'>Spybot<\/a> یا<a href='https://www.malwarebytes.com/' target='_blank'>Malwarebytes<\/a> ہی آپ محفوظ رہیں گے۔ اس زمرے میں ہم خصوصاً <\/li><li>ان میں مالویئر کو ختم کرنے کی خصوصیت بھی ہوتی ہے<\/li><li>۔جب تک آپ  کوایپس کی قانونی حیثیت کے متعلق تسلی نہ ہو اپنے کمپیوٹر یا فون پر  انہیں  انسٹال کرتے وقت ہوشیار رہیں۔ اپنے فون پر محض کوئی نیا گیم خریدتے وقت اپنے بنک کی تفصیلات دینا کوئی اچھا تاثر نہیں ہے<\/li><li>۔ ایسے لنکس کبھی نہ کھولیں جن کے ساتھ مشتبہ فائل اٹیچ منٹس ڈاؤن لوڈ کرنی ہوں کیونکہ اکثر تصاویر، ویڈیوز، آڈیو اور گریٹنگ کارڈز کیساتھ وائرس منسلک ہوتے ہیں لہٰذا ایسی مزاح والی ای میلز کو کھولتے وقت یا آگے بھیجنے سے پہلے ہمیشہ دو بار ضرور سوچیں<\/li><li> کہلائی جانے والی غیر محفوظ “exploits”۔ ہمیشہ اپنے فون اور کمپیوٹر کے سافٹ ویئر کو اپ ٹو ڈیٹ رکھیں کیونکہ  <\/li><li>چیزیں جو دیکھنے میں آئیں انہیں روز مرہ کے تحت حل کرتے رہیں تاکہ آپ کو ہمیشہ پتہ چلتا رہے کہ آپ محفوظ ہیں<\/ul>"
  },
  {
    id: 4,
    route: "Resources",
...
const usbs = [
  ...
  },
  {
    ...
    textPK: "<p>ہم اپنے مسودات، فوٹوز اوردیگر قیمتی ڈیٹا کو بیک اپ دینے یا انہیں ایک کمپیوٹر سے دوسرے تک منتقل کرنے کیلئے <\/p><p> ڈرائیوز کا استعمال کر سکتے ہیں۔ یہ بہت مفید سفری سٹوریج ڈیوائسز ثابت ہو سکتی ہیں۔ لیکن انہیں بھی کمزور کیاUSB<\/p><p>جا سکتا ہےجس کے نتیجے میں ہم اپنا ڈیٹا کھو بھی سکتے ہیں اور حادثاتی طور پر دوسروں کے کمپیوٹروں کو بھی متاثر کر سکتے ہیں۔<\/p>"
  },
  {
    id: 2,
    route: "Solution",
    ...
    textPK: "<p> میں یا اس سے کیا کاپی کر رہے ہیں لہٰذا جس طرح آپ اپنے کمپیوٹر USBیہ جاننا بہت ضروری ہے کہ آپ اپنی <\/p><p>یا فون کو محفوظ بناتے ہیں اس ڈرائیو کو بھی ایسے ہی محفوظ بنائیں۔ ان پہ اپنا ڈیٹا محفوظ کرنے کیلئے ہمیشہ یاد رکھیں کہ اپنی ڈرائیو کو ایک محفوظ مقام پہ رکھیں اور انہیں ضائع کرنے سے پہلے اس بات کی یقین دہانی کر لیں کہ آپ نے تمام ڈیٹا اس میں سے حذف کر دیا ہے۔<\/p>"
  },
  {
    id: 3,
    route: "Tips",
    textEN: "<ul><li>We do not recommend borrowing a USB drive or allowing someone to use yours, they can have spyware or malware on them which will infect your computer - cases of blackmail have arisen where women’s data was stolen after their computers were infected this way.<\/li><li>While we caution against sharing USB drives, we realise it’s common practice to do so and sometimes there are no other alternatives, so we advise you run the USB through anti-virus and anti-malware software every single time you use it.<\/li><li>If you must store sensitive data on your USB drive, look into buying a secure one with password protection.<\/li><\/ul>",
    textPK: "<ul><li> ڈرائیو کسی کو دیں یا کسی سے اس کی ڈرائیوادھارUSB۔ ہم آپ کو اس بات کی تجویز ہر گز نہیں دیں گے کہ آپ اپنیلیں، کیونکہ ان میں سپائے ویئر یا مالویئر ہو سکتے ہیں جو آپ کے کمپیوٹر کو متاثر کر سکتے ہیں۔ بلیک میلنگ کے بہت سے کیسز سامنے آئے ہیں جہاں خواتین کے کمپیوٹروں کو اسی طرح نقصان پہنچانے کے بعد ان کا ڈیٹا چرا لیا گیا تھا<\/li><li> لینے اور دینے کی احتیاط کے بارے میں بتاتے ہوئے ہم اس حقیقت سے بھی آگاہ ہوئے کہ ایسا کرنا USB۔ ایک عام عادت بن گئی ہے اور کبھی کبھار ایسا کرنا نا گزیر ہو جاتا ہے تو اس صورت میں ہم آپ کو یہ تجویز دیں گے کہ اگر کسی کی ڈرائیو استعمال کرنی پڑ جائے تو ہر بار اپنے کمپیوٹر پر اسے چلاتے ہوئے اینٹی وائرس اور اینٹی مالویئر سافٹ ویئر کیساتھ چلائیں۔<\/li><li> ڈرائیو پہ کوئی حساس ڈیٹا رکھنا ہو توخریدتے ہوئے یہ ضرور دیکھ لیں کہ وہ کافی محفوظ ہےUSB۔ اگر اپنی  اور اس کیساتھ پاس ورڈ حفاظت بھی میسر ہے۔<\/li><\/ul>"
  },
  {
    id: 4,
    route: "Resources"
