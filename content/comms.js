const social = [
  ...
  },
  {
    id: 3,
    route: "Tips",
    textEN: "Try looking at your account without signing in so you can see what is available to people outside your group of friends. Facebook allows you to organise your friends into lists - use this to control what your family, friends and very close friends see. Take time to understand the default privacy settings and learn how to change them.If you are using public devices, clear the browser history and sign out before you leave. Many social networking sites allow users to link information across other social networks - be careful about where you post or upload material because you might be anonymous on one website but exposed on the other one. Avoid providing your location. Every time you check in somewhere or upload a status with your current location, you are voluntarily telling people where to physically find you. Tap here for guidance on hiding your location. You should always make sure to use secure passwords, and enable two-factor authentication on the social media websites that have it. Tap here for guidance on this. Be very careful about the photos and videos you upload - they can be misused, shared and circulated. Even Snapchat photos can be saved easily before they disappear!",
    textPK: "۔ بغیر سائن ان ہوئے اپنے اکاؤنٹ کو دیکھنے کی کوشش کریں تاکہ آپ یہ دیکھ سکیں آپ کے حلقہ احباب کی جماعت سے باہر کے لوگوں کیلئے وہاں پر کیا کچھ موجود ہے۔ فیس بک آپ کو یہ اجازت دیتا ہے کہ آپ اپنے دوستوں کو لسٹس میں ترتیب دیں۔ اپنے دوستوں ، خاندان کے لوگوں اور بہت ہی قریبی ساتھیوں کو جو کچھ دکھانا چاہیں اس پر دسترس حاصل کرنے کیلئے اس کا استعمال کریں۔ پہلے سے مرتب شدہ پرائیویسی ترتیبات کو سمجھنے اور انہیں تبدیل کرنے کی بابت سیکھنے میں اپنا وقت لگائیں۔ اگر آپ عوامی ڈیوائسز استعمال کر رہے ہیں تو براؤزر ہسٹری کو صاف کردیں اور ڈیوائس کو چھوڑنے سے پہلے سائن آؤٹ ہو جائیں۔ بہت سی سماجی نیٹ ورکنگ سائٹس صارفین کو معلومات ایک سماجی نیٹ ورک سے دوسرے نیٹ ورکس تک منتقل کرنے کی اجازت دیتے ہیں لیکن کسی  بھی مواد کو پوسٹ یا اپ لوڈ کرتے وقت محتاط رہیں کیونکہ ایسا ہو سکتا ہے کہ ایک ویب سائٹ کیلئےتو آپ گمنام ہوں لیکن وہیں دوسری سائٹ کیلئے آپ آشکار ہوجائیں، جس سے کافی مسائل کا آپ کو سامنا ہو سکتا ہے۔۔ اپنی لوکیشن ظاہر کرنے سے پرہیز کریں۔ کیونکہ جب بھی آپ اپنی موجودہ لوکیشن کیساتھ کوئی سٹیٹس اپ لوڈ کرتے ہیں یا کہیں چیک ان ہوتے ہیں تو آپ رضاکارانہ طور پر  انجان لوگوں کو بھی یہ بتا رہے ہوتے ہیں کہ آپ اس وقت  ۔ ہمیشہ اس بات کی تسلی کرلیں آپ نے سوشل میڈیا ویب سائٹس پر  محفوظ پاس ورڈز لگائے ہیں اور دو طرفہ تصدیق  کو چالو کردیا ہے۔ اس پر رہنمائی حاصل کرنے کیلئے یہاں دیکھئے ۔ تصاویر اور ویڈیوز کو اپ لوڈ کرتے ہوئے احتیاط سے کام لیں کیونکہ ان کو پھیلا  کر ان کا غلط استعمال کیا جا سکتا ہے۔ حتٰی کہ کوئی بھی آپ کی  سنیپ چیٹ تصاویر کو غائب ہونے سے پہلے آسانی سے محفوظ کر سکتا ہے!"
  },
  {
    id: 4,
    route: "Resources",
...
const chat = [
  ...
  },
  {
    id: 3,
    route: "Tips",
    textEN: "With any chat app, only add contacts that you know personally - it’s better to add them later than to give your personal information to someone you don’t know who might misuse it. By default, WhatsApp saves all photos from conversations to your phone - meaning they’re easily accessible by anyone looking at your photo gallery! Consider password-protecting your chat apps with one of the options in the app store, such as Messenger and Chat Lock. Protect your WhatsApp profile photo and status from strangers by changing your privacy settings.",
    textPK: "۔ کسی بھی چیٹ ایپ کیساتھ صرف ذاتی جان پہچان والے لوگوں کی تفصیل ہی شامل کریں۔ کسی انجان شخص کو جو آپ کی ذاتی معلومات کا غلط فائدہ اٹھا سکتا ہو اسے  اپنی ذاتی معلومات دینے سے بہتر ہے کہ  اپنے رابطوں کی لسٹ میں اسے بعد میں شامل کریں۔ واٹس ایپ پہلے سے طہ شدہ ترتیبات کے تحت آپ کے فون پر ہونے والی گفتگو  سے تمام تصاویر محفوظ کر لیتا ہے جس کا مطلب یہ ہوا کہ جو کوئی بھی آپ کی فون گیلری میں دیکھ رہا ہوگا اس کیلئے ان تصاوہر تک پہنچنا آسان ہو جاتا ہے جیسے اختیارات ایپ سٹور میں موجود ہوتے ہیں، اپنے چیٹ ایپس کو پاس ورڈ  Chat LockاورMessenger کیساتھ محفوظ کرنے پر غور کریں۔ واٹس ایپ پر اپنی پرائیویسی ترتیبات کو تبدیل کر کے اجنبی لوگوں سے اپنی واٹس ایپ پروفائل تصویر اور اپنے سٹیٹس کو بچائیں"
  },
  {
    id: 4,
    route: "Resources",
